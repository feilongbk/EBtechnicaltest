public class ReadMe {
    ...
    3/ Run SimpleAggregationRunner_UT first to verify the result
        * add more input files if you want to observe the performance by looking at this line in the console:
        elapseTimeInMiliseconds: {Finding Max TimeStamp=6266, Aggregation=26924, Exporting=17892}
    4/ Run MultithreadingAggregationRunner_UT to see an optimization solution
     */
}
